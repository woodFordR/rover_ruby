...
[
  ...
  {
    name: "Thanksgiving Tiara",
    description: "Princess Calloway",
    file_name: "tiara.JPG",
  },
  {
    name: "Thanksgiving Chickens",
    description: "Calloway pets chickens",
    file_name: "chicks.JPG",
  },
  {
    name: "Logs to play with :)",
   description: "Calloway plays with logs.",
    file_name: "logs.JPG",
  },
  {
    name: "Calloway's toys",
    description: "Calloway plays with toys from her bookshelf",
    file_name: "done.JPG",
  },
  {
    name: "Ponytail for Calloway",
    description: "Dad's attempt at a ponytail :)",
    file_name: "pony.JPG",
  },
  {
    name: "Burnout",
    description: "Taking care of your burnout",
    file_name: "burn.JPG",
  },
  {
    name: "Lord of the Rings Quote",
    description: "There is good in this world and it's worth fighting for. -- JRR Tolkien",
    file_name: "rings.JPG",
  }
].each do |file|
  photo = Photo.create!({
